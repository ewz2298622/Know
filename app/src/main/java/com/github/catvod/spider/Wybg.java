...
public class Wybg extends Spider {
    ...
    private static final String siteHost = "www.wybg666.com";
    ...
    public void init(Context context) {
        super.init(context);
        try {
            playerConfig = new JSONObject("{\"duoduozy\":{\"show\":\"极速节点\",\"des\":\"\\/static\\/images\\/ico\\/ysgc.png\",\"ps\":\"0\",\"parse\":\"\"},\"qq\":{\"show\":\"QQ节点\",\"des\":\"\",\"ps\":\"0\",\"parse\":\"\"}}");
                    ...
                    if (playerConfig.has(player.getString("from"))) {
                       ...
                       System.out.println("zh" + doc);
                        ...
                        //    hashMap.put("tm", video_tm);
                            ...
                            hashMap.put("vkey", video_vkey);
                             hashMap.put("sign", video_sign);
                            OkHttpUtil.get(OkHttpUtil.defaultClient(), "hhttps://player.wybg666.com/xinapi.php", hashMap, new OKCallBack.OKCallBackString() {
                                @Override

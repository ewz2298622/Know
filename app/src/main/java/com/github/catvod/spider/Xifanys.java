...
public class Xifanys extends Spider {
    ...
    protected Pattern regexCategory = Pattern.compile("/vodtype/(\\S+).html");
    protected Pattern regexVid = Pattern.compile("/video/(\\S+).html");
    protected Pattern regexPlay = Pattern.compile("/vplay/(\\S+)-(\\d+)-(\\d+).html");
    protected Pattern regexPage = Pattern.compile("/vodshow/(\\S+).html");
    ...
    public String playerContent(String flag, String id, List<String> vipFlags) {
        try {
            ...
            //headers.put("origin", " https://www.6080dy1.com");
